...
%     end
    ...
    dy(5) = y(4)/S*70/500; % <lifetime learning by foraging honey bees, Anim. Behavior. 1994>mean total daily forage uptake mg is 150 mg. assuming this is only contributed from nectar intake. average foraging time during a forager lifespan in a foraging season is ~3.5. 
